...
const COURSE_NAMES: Record<string, string> = {
  cmhxa9lro0000qe3ctmwl2vb2:
    "Discovering the Science of Emotions: What Every Parent of a Teen Should Know",
  cmhxa9lrq0001qe3ctd3xmqo0:
    "Helping Teens Thrive: Emotional Intelligence for Parents",
  cmhxa9lrq0002qe3cmeq9p72i:
    "Parent Wellness & Positive Role Modeling for Teens",
  cmhxa9lrr0003qe3cbtbwhpx4:
    "Supporting Teen Emotional Expression: A Guide for Parents",
  cmhxa9lrr0004qe3c8zg468x5:
    "Supporting Teen Emotional Expression: A Guide for Parents",
  cmhxa9lrr0005qe3c7zdz9qnk:
    "Strengthening Emotional Bonds with Your Teen: A Parent's Guide",
};
...
export default function CoursesPage() {
  ...
  const [buyPlanType, setBuyPlanType] = useState<"standard" | "premium" | null>(
    null
  );
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 mt-2 w-48 rounded-xl bg-white shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
              ...
              >
                Premium Plan
                <p className="text-xs text-[#8F82B0] mt-1">
                  ₹2,994 for all courses
                </p>
              </button>
            </div>
          </div>
              ...
              {buyPlanType === "standard" ? (
                <>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start gap-3 p-4 rounded-lg border-2 border-gray-200 hover:border-[#8B2D6C] transition-colors cursor-pointer">
                      <input
                        type="checkbox"
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-[#2C1B3A]">
                          Zenomi Course
                        </p>
                  ...
                  <div className="mt-6 p-4 bg-[#F1E8FF] rounded-lg">
                    <div className="flex justify-between items-center">
                      <span className="font-semibold text-[#2C1B3A]">
                        Total:
                      </span>
                ...
                <>
                  <p className="text-[#53456B] mb-4">
                    Get access to all {trendingCourses.length} courses with our
                    Premium Plan!
                  </p>
                  <div className="space-y-3 mb-6">
                    {trendingCourses.map((course) => (
                      ...
                      >
                        <svg
                          className="w-6 h-6 text-[#8B2D6C] shrink-0 mt-0.5"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
                  ...
                  <div className="p-4 bg-linear-to-r from-[#8B2D6C] to-[#704180] rounded-lg text-white">
                    ...
                    <p className="text-sm text-white/80 mt-1">
                      Save ₹{trendingCourses.length * 499 - 2994} compared to
